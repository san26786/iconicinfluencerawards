...
export const metadata = { title: 'Manage Shortlists' };
    ...
    <div className="min-h-screen bg-ink grain pt-24">
      <div className="container-luxe section-pad py-12">
        ...
        <div className="mb-2">
          ...
          <h1 className="mt-1 font-display text-2xl font-semibold text-white sm:text-3xl">Manage Shortlists</h1>
          <p className="mt-1 text-sm text-white/40">Applications marked as shortlisted.</p>
        </div>
        <AwardNightNav />
        <ApplicationsListClient applications={rows} defaultStatus="shortlisted" />
      </div>
    </div>
  );
}
